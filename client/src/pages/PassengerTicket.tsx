      ...
      <div className="w-full max-w-2xl border border-gray-300 shadow-lg rounded-lg p-8 bg-card print:w-full print:max-w-none text-sm mt-10 mb-10">
          ...
          <div key={index} className="border-b py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <p>
                ...
                {flight.terminal} | <span className="font-semibold">Gate:</span>{" "}
                {flight.gate}
              </p>
              <p>
                <span className="font-semibold">Baggage:</span> {flight.baggage}{" "}
                | <span className="font-semibold">Meal:</span> {flight.meal}
              </p>
            </div>
          </div>
        ))}
        ...
        <div className="text-center pt-4 border-t mt-4">
          <p className="text-xs text-foreground">
            Form of Payment: {ticketData.paymentMethod}
          </p>
          <p className="text-xs text-foreground">
            Issued by: {ticketData.issuedBy}
          </p>
          <p className="text-xs text-foreground mt-2">
            Thank you for choosing Turistoe!
          </p>
        </div>
      </div>
    </div>
