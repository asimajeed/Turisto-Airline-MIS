        ...
        <div className="flex justify-center items-center min-h-screen  print:block">
            <div className="w-full max-w-2xl border border-gray-300 shadow-lg rounded-lg p-8 bg-card print:w-full print:max-w-none text-sm mt-10 mb-10">
                ...
                <div className="text-center border-b pb-4 mb-6">
                    <h1 className="text-2xl font-bold text-foreground">Turistoe</h1>
                ...
                {ticketData.flights.map((flight, index) => (
                    <div key={index} className="border-b py-4">
                        <p className="font-medium text-theme-primary mb-2">{flight.flight}</p>
                ...
                <div className="text-center pt-4 border-t mt-4">
                    <p className="text-xs text-foreground">Form of Payment: {ticketData.paymentMethod}</p>
                    <p className="text-xs text-foreground">Issued by: {ticketData.issuedBy}</p>
                    <p className="text-xs text-foreground mt-2">Thank you for choosing Turistoe!</p>
                </div>
            </div>
        </div>
    );
