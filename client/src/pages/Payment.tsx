                    ...
                    {!showSummary ? (
                        <>
                            ...
                            <div className="col-span-2">
                                ...
                                {/* Credit Card Details */}
                                <div className="mt-6">
                                    <h3 className="text-lg font-semibold text-purple-900">Credit card details</h3>
                            ...
                            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                                ...
                                <div className="mt-4 space-y-4">
                                    ...
                                    <div className="bg-white p-4 rounded-lg border border-gray-200 flex justify-between items-center">
                                        <div>
                                            <p className="font-medium text-purple-900">Hawaiian Airlines - FIG4312</p>
                                            <p className="text-sm text-gray-500">16h 45m (+1d) - 7:00 AM to 4:15 PM</p>
                                        </div>
                                    ...
                                    <Drawer open={paymentSuccess}>
                                        <DrawerContent>
                                            <DrawerHeader>
                                                ...
                                                >
                                                    <DrawerTitle className="text-green-600 text-2xl font-bold">Payment Successful!</DrawerTitle>
